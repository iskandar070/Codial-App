...
import com.example.codialapp.Adapters.StudentsAdapter
import com.example.codialapp.databinding.DialogDeleteBinding
import com.example.codialapp.databinding.FragmentShowGroupsBinding
    ...
    class ShowGroupsFragment : Fragment() {
        ...
        private fun buildDialogDelete(students: Students) {
            ...
            bindingDelete.tvDelete.setOnClickListener {
                ...
                if (boolean) {
                    Toast.makeText(requireActivity(), "Successfully Delete!", Toast.LENGTH_SHORT)
                        .show()
                } else {
